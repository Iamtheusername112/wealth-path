    ...
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row gap-6 items-center">
        ...
        <div className="relative group">
          <div className="relative w-96 h-60 rounded-2xl shadow-xl overflow-hidden transition-transform duration-300 group-hover:scale-105">
            <div className={`absolute inset-0 bg-gradient-to-br ${style.gradient}`}>
              ...
              <div className="relative h-full p-6 flex flex-col">
                {/* Bank name - top */}
                <div className="mb-4">
                  <p className={`text-lg font-bold ${style.textColor} opacity-90`}>
                    CAPITALPATH
                  </p>
                </div>
                ...
                <div className="flex justify-between items-start mb-12">
                  {/* Real EMV Chip */}
                  <div className="relative w-14 h-10 rounded-lg bg-gradient-to-br from-yellow-400 via-yellow-500 to-yellow-600 shadow-lg border border-yellow-600">
                  ...
                  <div className={`text-xl font-bold ${style.textColor} pr-16`}>
                    {getNetworkLogo()}
                  </div>
                </div>
                ...
                <div className="flex-1 flex items-center justify-center">
                  <p className={`text-xl font-mono font-semibold tracking-widest ${style.textColor}`}>
                ...
                <div className="flex justify-between items-end mb-12">
                  <div className="flex-1">
                    <p className={`text-base font-medium ${style.textColor}`}>
        ...
        <div className="relative group">
          <div className="relative w-96 h-60 rounded-2xl shadow-xl overflow-hidden transition-transform duration-300 group-hover:scale-105">
            <div className={`absolute inset-0 bg-gradient-to-br ${style.gradient}`}>
              ...
              <div className="relative h-full p-6 pt-16">
                {/* Magnetic stripe */}
                <div className="absolute top-8 left-0 right-0 h-12 bg-black"></div>
                
                {/* Signature panel */}
                <div className="bg-white rounded-lg p-3 mb-8">
                ...
                <div className="space-y-6">
                  <div>
                    <button
                      ...
                      className={`font-mono text-lg ${style.textColor} hover:opacity-80 flex items-center gap-2`}
                    >
                      {showDetails ? (card.card_number || '1234 5678 9012 3456') : '•••• •••• •••• ••••'}
                  ...
                  <div className="flex justify-end items-center">
                    <div className="flex flex-col items-center">
                      <Wifi className={`h-6 w-6 rotate-90 ${style.textColor} opacity-60`} />
                      <span className={`text-xs ${style.textColor} opacity-50 mt-1`}>CONTACTLESS</span>
                    </div>
                  </div>
                </div>
      ...
      <div className="grid grid-cols-3 gap-4 p-4 bg-muted/50 rounded-xl">
        <div className="text-center">
          ...
          <p className="font-semibold">{formatCurrency(parseFloat(card.credit_limit))}</p>
        </div>
        <div className="text-center">
